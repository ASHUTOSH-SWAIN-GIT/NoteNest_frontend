      ...
      <form className="my-8" onSubmit={handleSubmit}>
        <div className="mb-4 flex flex-col space-y-2 md:flex-row md:space-y-0 md:space-x-2">
          <LabelInputContainer>
            ...
            <Input id="firstname" placeholder="Enter yout username" type="text" />
          </LabelInputContainer>
        </div>
        ...
        <LabelInputContainer className="mb-4">
          ...
          <Input id="password" placeholder="Enter a strong password" type="password" />
        </LabelInputContainer>
        <LabelInputContainer className="mb-8">
          <Label htmlFor="twitterpassword">Your twitter password</Label>
          <Input id="twitterpassword" placeholder="confirm your password" type="twitterpassword" />
        </LabelInputContainer>
